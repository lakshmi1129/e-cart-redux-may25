  ...
  return (
    <nav className='flex bg-blue-400 fixed w-full p-5 text-white' >
      ...
      <ul className='flex-1 text-right'>
        {insideHome && <li className='list-none inline-block px-5'><input style={{width:"300px"}} className='rounded border p-2' placeholder='Search products Name' type="text" /></li>}
